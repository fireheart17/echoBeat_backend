...
public class PerksController {
    ...
    public ResponseEntity<List<String>> getPerkBySubscriptionId(@PathVariable("subscriptionId") long subscriptionId) {
        try {
            List<String> ls = perksRepository.findBySubscriptionId(subscriptionId);
